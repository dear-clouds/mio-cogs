...
class JobView(discord.ui.View):
    def __init__(self, jobs_cog, job_id: int, apply_emoji: str):
        ...
        apply_button = discord.ui.Button(label=f"{self.apply_emoji} Apply", style=discord.ButtonStyle.primary, custom_id=f"apply_button_{job_id}")
        apply_button.callback = self.apply_button
        self.add_item(apply_button)

        # Create and add the "Untake Job" button
        untake_button = discord.ui.Button(label="Untake Job", style=discord.ButtonStyle.danger, custom_id=f"untake_button_{job_id}")
        untake_button.callback = self.untake_button
        self.add_item(untake_button)
        
        # Create and add the "Mark job as done" button
        job_done_button = discord.ui.Button(label="Mark job as done", style=discord.ButtonStyle.green, custom_id=f"job_done_button_{job_id}")
